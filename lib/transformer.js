...
function _transformEvent(vEvent) {
  ...
  if (transformed && transformed.start) {
    ...
    Object.assign(transformed, {
      start: {
        tzid: vStartKey.split(';TZID=')[1],
        value: moment(vEvent[vStartKey]).toDate(),
      }
    });
  ...
  if (transformed && transformed.end) {
    ...
    Object.assign(transformed, {
        ...
        value: moment(vEvent[vEndKey]).toDate(),
      }
    });
...
function transformCalendar(json) {
  ...
  if (calendar.VTIMEZONE) {
    ...
    if (standard && standard[0]) {
      Object.assign(transformed.timezone, { standard: { tzname: standard[0].TZNAME }});
    }
    if (daylight && daylight[0]) {
      Object.assign(transformed.timezone, { daylight: { tzname: daylight[0].TZNAME }});
    }
